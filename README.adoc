...
== Diagramming
The devcontainer uses https://asciidoctor.org[Asciidoctor] to generate the documentation. The architecture diagram is created using https://mermaid.js.org[Mermaid].
