...
architecture-beta
    ...
    service spring_boot(API-Server)[Server] in games_service
    service prometheus(devicon:prometheus-wordmark)[Prometheus] in games_service
    service grafana(devicon:grafana-wordmark)[Grafana] in games_service
